        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-white text-center md:text-left">
            ...
            <p className="text-lg text-white text-opacity-90 max-w-xl mx-auto md:mx-0 mb-10">
              Instantly check if your resume can pass Applicant Tracking Systems (ATS). Analyze formatting, sections, keywords, and more – all for free. No sign-up required.
            </p>

            {/* CTA */}
           <a href="#ats-checker-form">
          ...
          <div className="flex justify-center md:justify-end">
            <div className="transform rotate-2 hover:rotate-0 transition-transform duration-300">
              <Image
                src="/ats.png" 
                alt="ATS Resume Checker Illustration"
                width={400}
                height={500}
