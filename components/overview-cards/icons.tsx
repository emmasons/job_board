...
export function CVIcon(props: SVGPropsType) {
  return (
    <svg width={58} height={58} viewBox="0 0 58 58" fill="none" {...props}>
      <circle cx={29} cy={29} r={29} fill="#00C49A" />
      <path
        d="M37 18H21a2 2 0 00-2 2v18a2 2 0 002 2h16a2 2 0 002-2V20a2 2 0 00-2-2z"
        fill="#fff"
      />
      <rect x="24" y="23" width="10" height="2" rx="1" fill="#00C49A" />
      <rect x="24" y="28" width="10" height="2" rx="1" fill="#00C49A" />
      <rect x="24" y="33" width="6" height="2" rx="1" fill="#00C49A" />
      <path
        d="M34 22v-3.5L37.5 22H34z"
        fill="#E6FFF7"
      />
    </svg>
  );
...
export function SubscribersIcon(props: SVGPropsType) {
  return (
    <svg width={58} height={58} viewBox="0 0 58 58" fill="none" {...props}>
      <circle cx="29" cy="29" r="29" fill="#FF6B6B" />
      <path
        d="M21.5 35.5C21.5 32.7386 24.3137 30.5 28 30.5C31.6863 30.5 34.5 32.7386 34.5 35.5V36C34.5 36.8284 33.8284 37.5 33 37.5H23C22.1716 37.5 21.5 36.8284 21.5 36V35.5Z"
        fill="#fff"
      />
      <circle cx="28" cy="26" r="3.5" fill="#fff" />
      <path
        d="M38 25.5C38 24.1193 36.8807 23 35.5 23C35.2742 23 35.0531 23.0344 34.8433 23.1C35.1105 23.6436 35.25 24.2954 35.25 25C35.25 25.7046 35.1105 26.3564 34.8433 26.9C35.0531 26.9656 35.2742 27 35.5 27C36.8807 27 38 25.8807 38 24.5V25.5Z"
        fill="#fff"
      />
      <path
        d="M18 25.5C18 24.1193 19.1193 23 20.5 23C20.7258 23 20.9469 23.0344 21.1567 23.1C20.8895 23.6436 20.75 24.2954 20.75 25C20.75 25.7046 20.8895 26.3564 21.1567 26.9C20.9469 26.9656 20.7258 27 20.5 27C19.1193 27 18 25.8807 18 24.5V25.5Z"
        fill="#fff"
      />
    </svg>
  );
