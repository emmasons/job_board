...
CREATE TABLE `GCPData` (
    `id` VARCHAR(191) NOT NULL,
    `urlExpiryDate` DATETIME(3) NOT NULL,
...
CREATE TABLE `Job` (
    ...
    `workSchedule` ENUM('FULL_TIME', 'PART_TIME', 'CONTRACTOR', 'TEMPORARY', 'SEASONAL', 'NOT_SPECIFIED') NOT NULL DEFAULT 'NOT_SPECIFIED',
    `country` VARCHAR(191) NOT NULL,
    `city` VARCHAR(191) NOT NULL,
...
CREATE TABLE `WorkScheduleOnJobAlert` (
    `id` VARCHAR(191) NOT NULL,
    `jobAlertId` VARCHAR(191) NOT NULL,
    `workSchedule` ENUM('FULL_TIME', 'PART_TIME', 'CONTRACTOR', 'TEMPORARY', 'SEASONAL', 'NOT_SPECIFIED') NOT NULL,
