...
const page = async () => {
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="mb-4">
        Welcome to JobsConnect. These terms and conditions outline the rules and
        regulations for the use of our platform. By accessing this website, we
        assume you accept these terms and conditions in full. Do not continue to
        use JobsConnect if you do not accept all of the terms and conditions
        stated on this page.
      </p>
      ...
      <p className="mb-4">
        ...
        pages from https://jobsconnect.com for your own personal use subject to
        restrictions set in these terms and conditions.
      </p>

      <h2 className="mb-4 text-2xl font-semibold">User Responsibilities</h2>
      <p className="mb-4">
        By using our platform, you agree to use it only for lawful purposes and
        in a way that does not infringe the rights of, restrict, or inhibit
        anyone else's use and enjoyment of the platform. Prohibited behavior
      ...
      <p className="mb-4">
        ...
        things, or you have advised JobsConnect of the possibility of such
      ...
      <p className="mb-4">
        ...
        or current. JobsConnect may make changes to the materials contained on
